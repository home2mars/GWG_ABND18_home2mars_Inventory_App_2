...
public class InventoryActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inventoryListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                // For example, the URI would be "content://com.example.android.gwg_abnd18_home2mars_inventory_app_2/inventories/2"
    ...
    private void insertInventory() {
        ...
        // Insert a new row for Java Progamming into the provider using the ContentResolver.
        // Use the {@link InventoryEntry#CONTENT_URI} to indicate that we want to insert
        // into the inventories database table.
        // Receive the new content URI that will allow us to access Java Programming's data in the future.
